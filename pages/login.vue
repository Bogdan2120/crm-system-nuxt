...
<template>
    <div class="flex items-center justify-center min-h-screen w-full">
        <div class="rounded bg-sidebar w-1/4 p-5">
            <h1 class="text-2xl font-bold text-center nb-5">Login</h1>
            <form>
                ...
                <div class="flex items-center justify-center gap-5">
                    <UiButton type="submit" class="w-1/2" @click="login">Login</UiButton>
                    <UiButton type="button" class="w-1/2" @click="register">Register</UiButton>
                </div>
            </form>
        </div>
    </div>
